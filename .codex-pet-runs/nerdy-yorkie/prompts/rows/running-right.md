Create a single horizontal sprite strip for the Codex app digital pet `nerdy-yorkie` in the state `running-right`.
...
Output exactly 8 separate animation frames arranged left-to-right in one single row. Each frame must show the same pet: Tiny chibi Yorkshire Terrier, tan and steel-blue fur, round nerd glasses, a small pink bow tucked behind one ear or a tiny pink flower, expressive eyebrows, quirky curious energy, sometimes lays around snoring while the user builds. No bow tie, no suit, no sweater vest; keep clothing/accessories minimal and cute..
